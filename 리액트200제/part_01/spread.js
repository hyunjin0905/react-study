...
class SpreadOperator extends Component {
  ...
  componentDidMount() {
    ...
    console.log(sumVarArr); // es6 arry
    ...
    console.log(JSON.stringify(sumVarObj)); // es6 object

    var sumLetObj = { ...varObj1,
      ...varObj2
    };
  ...
  render() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", null, "this is spread"));
  }
